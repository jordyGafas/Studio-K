...
var pandaProjectDescription = function() {
  ...
  if ($(".js-project-description")[0]) {
    var readmore = $(".js-project-description")[0].dataset.rmore;
    var showless = $(".js-project-description")[0].dataset.rless;
    $(".js-project-description").readmore({
      speed: 200,
      collapsedHeight: 250,
      moreLink:
        '<a href="#" class="btn--inline btn--inline-plus">' + readmore + "</a>",
      lessLink:
        '<a href="#" class="btn--inline btn--inline-min">' + showless + "</a>",
